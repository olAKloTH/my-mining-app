        ...
        <form className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" className="w-full bg-slate-950 border border-white/10 rounded-xl p-3 text-white focus:ring-2 focus:ring-yellow-500 outline-none" placeholder="ชื่อ" required />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-400 mb-1">นามสกุล</label>
              <input type="text" className="w-full bg-slate-950 border border-white/10 rounded-xl p-3 text-white focus:ring-2 focus:ring-yellow-500 outline-none" placeholder="นามสกุล" required />
            </div>
          </div>
          ...
          <div>
            ...
            <input type="tel" className="w-full bg-slate-950 border border-white/10 rounded-xl p-3 text-white focus:ring-2 focus:ring-yellow-500 outline-none" placeholder="08x-xxx-xxxx" required />
          </div>

          <div>
            <label className="block text-sm font-medium text-slate-400 mb-1">ที่อยู่</label>
            <input type="text" className="w-full bg-slate-950 border border-white/10 rounded-xl p-3 text-white focus:ring-2 focus:ring-yellow-500 outline-none" placeholder="บ้านเลขที่, ซอย, ถนน, ตำบล, อำเภอ" required />
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-slate-400 mb-1">จังหวัด</label>
              <select defaultValue="" className="w-full bg-slate-950 border border-white/10 rounded-xl p-3 text-white focus:ring-2 focus:ring-yellow-500 outline-none" required>
            ...
            <div>
              ...
              <input type="text" maxLength={5} pattern="[0-9]{5}" className="w-full bg-slate-950 border border-white/10 rounded-xl p-3 text-white focus:ring-2 focus:ring-yellow-500 outline-none" placeholder="10xxx" required />
            </div>
          </div>

          <div className="space-y-3 mt-6 pt-6 border-t border-white/10">
            <div className="flex items-start gap-2">
              <input type="checkbox" id="age" className="mt-1 accent-yellow-500" required />
              <label htmlFor="age" className="text-xs text-slate-400">
                ยืนยันว่าอายุ 18 ปีขึ้นไป เพื่อรับสิทธิ์ลุ้นรับรางวัลใหญ่พิเศษช่วง OBT
              </label>
            </div>

            <div className="flex items-start gap-2">
              <input type="checkbox" id="terms" className="mt-1 accent-yellow-500" required />
              <label htmlFor="terms" className="text-xs text-slate-400">
                ยอมรับ <Link href="/tos" className="text-yellow-500 hover:underline">เงื่อนไขการใช้งาน (ToS)</Link> และนโยบายการแจกของรางวัล (คะแนนสะสมสมนาคุณ)
              </label>
            </div>

            <div className="flex items-start gap-2">
              <input type="checkbox" id="marketing" className="mt-1 accent-yellow-500" required />
              <label htmlFor="marketing" className="text-xs text-slate-400">
                ยินยอมให้ทีมงานนำชื่อบัญชีหรือสื่อที่เกี่ยวข้อง ไปใช้ในการโฆษณาและประชาสัมพันธ์โดยไม่มีเงื่อนไขเรียกร้องค่าตอบแทน
              </label>
            </div>
          </div>
